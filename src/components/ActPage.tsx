...
/**
 * ACT PAGE - Disaster Action Checklists
 * 
 * PURPOSE:
 * Displays interactive checklists for acting when a natural disaster has arrived.
 * Users can check off tasks, which are saved to their account or browser.
 * 
 * STRUCTURE:
 * - Risk type selection
 * - Phase tabs (Coming, Here)
 * - Interactive checklists
 * 
 * DATA ORGANIZATION:
 * The `checklists` object contains all tasks:
 *   checklists[hazardType][phase] = array of checklist sections
 *   - hazardType: "avalanche", "cold", "earthquake", "flood", "hail", "heat", "hurricane", "ice", "landslide", "lightning", "tornado", "tsunami", "volcanic", "wildfire", "wind", "winter"
 *   - phaseType: "coming", "here"
 * PROGRESS TRACKING:
