...
export default function PreparePage() {
  ...
  const categories = [
    ...
    { id: 'volcanic', label: 'Volcanic', color: 'bg-primary' },
    { id: 'wildfire', label: 'Wildfire', color: 'bg-primary' },
    { id: 'wind', label: 'Wind', color: 'bg-primary' },
    { id: 'winter', label: 'Winter', color: 'bg-primary' },
  ];
